<script type = "text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery('form#wordpress-form-acm').submit(function () {
            ...
            jQuery('#submit_acumba').val('Sending...');
            ...
            jQuery.ajax({
                ...
                if (data == "Te has suscrito correctamente.") {
                    ...
                    if (double_optin == "1") {
                        ...
                        jQuery('#acumba_response').html('You have been successfully subscribed');
                    }
...
<?php
    ...
    if ($list != '') {
        ...
        if (empty($title)) $title = __('Subscribe to our newsletter','acumbamail-signup-forms');
